...
const Navber = () => {
  return (
    ...
    >
      ...
      {/* Centered Content */}
      <div className="flex  justify-center items-center h-full text-center px-14 py-10 bg-black bg-opacity-50">
        <div>
          <img src={mainicon} alt="Nav Icon" className="h-24 mb-4 mr-28" />
        </div>
